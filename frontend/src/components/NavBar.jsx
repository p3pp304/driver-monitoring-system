...
export default function NavBar({ techStatus, userStatus, safetyScore, sessionStatus, toggleJourney }) {
  return (
        <header className="mb-8 flex gap-6 justify-between items-center bg-gray-900 p-6 rounded-2xl border border-gray-800">
            {/* Titolo */}
            ...
            <div>
                <button 
                    ...
                    className={`font-bold py-3 px-8 rounded-xl text-lg ${
